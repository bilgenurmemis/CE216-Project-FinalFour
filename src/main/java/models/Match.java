...
public class Match implements Serializable {
    ...
    public BaseTeam getHomeTeam() { return homeTeam; }
    public void setHomeTeam(BaseTeam homeTeam) { this.homeTeam = homeTeam; }
    public BaseTeam getAwayTeam() { return awayTeam; }
    public void setAwayTeam(BaseTeam awayTeam) { this.awayTeam = awayTeam; }
    ...
    public void setMatchWeek(int matchWeek) { this.matchWeek = matchWeek; }
